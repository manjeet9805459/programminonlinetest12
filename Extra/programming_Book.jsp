     ...
     <!-- Nav -->
      ...
      <nav class="navbar navbar-inverse">
       ...
       <div class="container">
            ...
            <div class="row" >
            <div class="col-lg-12">
             <h2 class="page-header">Top Programming book
                    <small>list....</small>
                </h2>
                <hr>
            ...
            <img class="img-responsive" src="/imagedata/java1.jpg" style="height:150px;width:150px"
                 alt="">
            </a>
            <h3> Java book 1</h3>
                  ...
                  <img class="img-responsive" src="/imagedata/java2.jpg" style="height:150px;width:150px"
                  alt="">
               ...
               <img class="img-responsive" src="/imagedata/java3.jpg" style="height:150px;width:150px"
                  alt="">
                ...
                <h3>
                  ...
                  <div class="col-md-3 portfolio-item">
                  <img class="img-responsive" src="/imagedata/java4.jpg" style="height:150px;width:150px"
                 alt="">
                  <h3>java book 4</h3>
                </div>
                
                <div class="col-md-3 portfolio-item">
                <img class="img-responsive" src="/imagedata/cpp1.jpg" style="height:150px;width:150px"
                  alt="">
                <h3>
                   c++ book 1
                </h3>
                  ...
                  <div class="col-md-3 portfolio-item">
                  <img class="img-responsive" src="/imagedata/cpp2.jpg" 
                ...
                <h3>
                  ...
                  <div class="col-md-3 portfolio-item">
             <img class="img-responsive" src="/imagedata/cpp3.jpg" style="height:150px;width:150px"
                  alt="">
                   <h3>
                    c++ book 3
                </h3>
                  ...
                  <div class="col-md-3 portfolio-item">
              <img class="img-responsive" src="/imagedata/cpp4.jpg" style="height:150px;width:150px"
                  alt="">
                  <h3>
                    c++ book 4
                </h3>
                ...
                <div class="col-md-3 portfolio-item">
                    <img class="img-responsive" src="/imagedata/c1.jpg" style="height:150px;width:150px"
                 alt="">
                  <h3>
                    c book 1
                </h3>
                ...
                <div class="col-md-3 portfolio-item">
                <img class="img-responsive" src="/imagedata/c2.jpg" 
                     style="height:150px;width:150px;" alt="">
                </a>
                <h3>
                    c book 2
                  ...
                  <div class="col-md-3 portfolio-item">
                 <img class="img-responsive" src="/imagedata/c3.jpg" 
                ...
                <h3>
                  ...
                  <div class="col-md-3 portfolio-item">
             <img class="img-responsive" src="/imagedata/c4.jpg" style="height:150px;width:150px"
                  alt="">
              <h3>
                    c book 4
                </h3>
