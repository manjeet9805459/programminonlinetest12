       ...
       <div class="container-fluid">
        ...
        <span class="icon-bar"></span>                        
          ...
          <!--start InterView Question-->
            ...
            <a href="/questiontestSeriesHome?testName=${user.testName}">
             <img class="img-responsive" src="${user.imageURL}" style="margin-left: 30px;height:115px;width:115px"
                alt="">
            </a>
            <h3>
            <a href="/questiontestSeriesHome?testName=${user.testName}" style="margin-left: 30px;font-size: 20px">${user.testName}</a>
            </h3>
