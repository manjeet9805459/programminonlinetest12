    ...
    <div class="container">
       <div class="container-fluid">
        ...
        <div class="row" style="background-color:#ADDFFF">
            <div class="col-lg-12">
                <center>
                <h2 class="page-header">Interview Question List</h2>
                <hr>
                </center>
            </div>
        
             <c:forEach items="${listBook}" var="question">
           <h3>Question <%=i++ %> : <c:out value="${question.question}"/>?</h3>
          <ul class="list-group">
      <li class="list-group-item" style="background-color:whitesmoke"><h4>Answer = <c:out value="${question.answer}"/></h4></li>
  </ul>
  </c:forEach>
</div>
</div>
