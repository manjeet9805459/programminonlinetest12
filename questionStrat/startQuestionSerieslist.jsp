     ...
     <!-- Page Content -->
        ...
        <h2>Test series List</h2>
         ...
         <hr>
           ...
           <ul class="list-group">
           <il>
           <a class="btn btn-info btn-lg" style="background-color: #008080" role="button"  href="/questionReadHome?testSeriesNumber=<c:out value="${question.questionSeries}"/>&testName=${testName}"><b>&nbsp Question Series &nbsp<c:out value="${question.questionSeries}" /></b></a>
           </il>
           </ul>
         </center>
        </c:forEach>
