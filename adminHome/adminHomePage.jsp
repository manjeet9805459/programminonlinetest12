...
<meta name="author" content="ProgrammingOnlineTest">
  ...
  <ul class="list-group">
      <il>
          ...
          <a class="btn btn-info btn-lg" role="button" style="background-color: #008080" href="/admin_Panel?email=<%=s1%>"><b><center> &nbsp  &nbsp  Test Admin Panel  &nbsp    &nbsp</center></b></a>
      </il>
      <br>
      <br>
      <il>
     <a class="btn btn-info btn-lg" role="button" style="background-color: #008080" href="/interViewAdmin?email=<%=s1%>"><b>Question Admin Panel</b></a>
      </il>
  </ul>
</center>
</div>
