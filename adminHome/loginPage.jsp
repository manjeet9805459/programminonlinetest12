        ...
        <div class="col-md-4 col-md-offset-4">  
           ...
           <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Admin Panel Login</h3>  
                </div>  
                
                <div class="panel-body">  
                    <form role="form" name="form" action="/LoginServlet" method="post" onsubmit="return validate()">  
                        <fieldset>  
                    ...
                    <center><b>you don`t have account<br> go to registraion?</b> <br></b><a href="/adminHome/registrationPage.jsp">Registrion Here</a></center><!--for centered text-->  
                </div>  
            </div> 
                             <br>
        </div>  
