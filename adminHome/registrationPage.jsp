...
{ 
 ...
 var admin_name=document.form.admin_name.value;
 ...
 { 
 alert("admin_name cannot be blank"); 
 return false; 
 }
 ...
 return false; 
    ...
    <!-- Navigation -->
              ...
              <div class="col-md-4 col-md-offset-4"> 
                  <br>
                    <br>
                    <span style="color:red;font-size: 20px"><%=(request.getAttribute("errMessage") == null) ? ""
                            : request.getAttribute("errMessage")%></span><br>  
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                    
                    <h3 class="panel-title">Admin Registration from</h3>  
                </div>  
                <div class="panel-body">   
                    <form role="form" method="post" action="/RegisterServlet"  onsubmit="return validate()" name="form">  
                        <fieldset>  
                            <div class="form-group">  
                                <input class="form-control" placeholder="Username" name="Username" type="text" autofocus>  
                            </div>  
                             <div class="form-group">  
                               <input class="form-control" placeholder="admin-refer-name" name="admin_name" type="text" value="" autofocus>   
                            </div>
                            <div class="form-group">  
                    ...
                    <center><b>Already registered ?</b><br></b><a href="/adminHome/loginPage.jsp">Login here</a></center><!--for centered text-->  
                </div>  
            </div> 
           <br>
        </div>  
