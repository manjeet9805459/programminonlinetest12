            ...
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                 ...
                 <div class="panel-body">  
                  <form action="/interEdittestName1"  method="get">  
                        <fieldset> 
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" name="email" value="<%=s1 %>" type="hidden" required autofocus>   
                            </div>
                           <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" value="<%=message %>" name="testName" type="text" autofocus />   
                            </div>
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" value="<%=message %>" name="testName1" type="hidden" autofocus />   
                            </div>
