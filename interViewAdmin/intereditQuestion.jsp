           ...
           <button class="btn btn-default" type="submit">Go</button>
            ...
            <div class="login-panel panel panel-success">  
                ...
                <div class="panel-body">  
                    <form role="form"  action="/InterEditQuestion1"  method="get" onsubmit="return validate()" name="form">  
                        ...
                        <fieldset>
                            <div class="form-group">  
                             ...
                             <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" value="${question.questionNumber}" name="questionNumber" type="text" autofocus />   
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="question" name="question" type="text" value="${question.question}">  
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="True Answer" name="trueAnswer" type="text" value="${question.answer}">  
                            </div>
                      
                            <%=(request.getAttribute("errMessage") == null) ? ""
                             : request.getAttribute("errMessage")%>
                    <input class="btn btn-mg btn-success btn-block" type="submit" value="ADD" name="Register" > 
