...
#customers th {
    ...
    <h3><p>create New Question List to click add test......</p></h3>
    <h4><a class="btn btn-primary btn-rounded btn-sm my-0" href="/interViewAdmin/interAddQuestion.jsp?email=<%=s1%>">Add New Question InterView Programming</a></h4>
      <hr>
    ...
    <tr>
        ...
        <td>
         <a class="btn btn-primary btn-rounded btn-sm my-0" href="/interAddQuestionSeries?email=<%=s1%>&testName=<c:out value="${question.testName}"/>"><b> ADD Question Series </b></a>&nbsp
       </td>
       <td>
           <a class="btn btn-primary btn-rounded btn-sm my-0" href="/interQuestionSeries?email=<%=s1%>&testName=<c:out value="${question.testName}"/>"><b> Read  Question </b></a>&nbsp 
       </td>
       <td>
            <a class="btn btn-primary btn-rounded btn-sm my-0" href="/interedithome?email=<%=s1%>&testName=<c:out value="${question.testName}"/>"><b>Edit Question</b></a>&nbsp
       </td>
       <td>
           <a class="btn btn-primary btn-rounded btn-sm my-0" href="/interdeleteQuesServlet?email=<%=s1%>&testName=<c:out value="${question.testName}"/>"><b> Delete Question  </b></a>  
       </td>
