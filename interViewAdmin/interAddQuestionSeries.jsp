           ...
           <button class="btn btn-default" type="submit">Go</button>
            ...
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Registration of the user</h3>  
                </div>  
                <div class="panel-body"> 
                    <c:forEach items="${listBook}" var="q1">
                    <form action="/interAddQuestion"  method="get">  
                        <fieldset> 
                             <div class="form-group">  
                               <input class="form-control" placeholder="Test Name"  value="${q1.testName}" name="testName" type="text" autofocus>   
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="Test Series Number" value="${q1.questionSeries}" name="testSeriesNumber" type="text" autofocus>  
                            </div>
                                   <div class="form-group">  
                                <input class="form-control" placeholder="imageURL" value="${q1.imageURL}" name="imageURL" type="text" autofocus>  
                            </div>
                            ...
                            <div class="form-group">  
                                <input class="form-control" placeholder="question Number" name="questionNumber" type="text" autofocus>  
                            </div>  
                            <div class="form-group">  
                                <input class="form-control" placeholder="question" name="question" type="text" autofocus>  
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="True Answer" name="trueAnswer" type="text" autofocus>  
                            </div>
                           <input class="btn btn-lg btn-success btn-block" type="submit" value="ADD"> 
                          <a href="/interViewAdmin?email=<%=s1%>" id="cancel" name="cancel" class="btn btn-lg btn-success btn-block">Cancel</a>
                        </fieldset>  
                       </form> 
                    </c:forEach>
              </div>  
