        ...
        <span class="icon-bar"></span>                        
           ...
           <button class="btn btn-default" type="submit">Go</button>
              ...
              <div class="col-md-4 col-md-offset-4">  
                  <h2 class="page-header">&nbsp &nbsp &nbsp &nbsp &nbsp<%=questionNumber %> /25
                   <hr>
                   </h2>
                    ...
                    <form role="form"  action="/interAddQuestion1"  method="get" onsubmit="return validate()" name="form">  
                        <fieldset>
                           ...
                           <div class="form-group">  
                            ...
                            <div class="form-group">  
                                <input class="form-control" placeholder="Question number" name="questionNumber" type="int" value="<%=questionNumber %>" required >  
                            </div> 
                            <div class="form-group">  
