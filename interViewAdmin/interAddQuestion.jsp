                    ...
                    <div class="login-panel panel panel-success">  
                     ...
                     <form action="/interAddQuestion"  method="get">  
                        <fieldset>  
                            ...
                            <div class="form-group">  
                                <input class="form-control" placeholder="Test Series Number" value="<%=tsn %>" name="testSeriesNumber" type="text" required autofocus>  
                            </div>
                             <div class="form-group">  
                                <input class="form-control" placeholder="image URL" name="imageURL" type="text" required autofocus>  
                            </div>
                               
                            <center><b><h2>Add The Question</h2></b></center>
                        
                            <div class="form-group">  
                                <input class="form-control" placeholder="question Number" value="<%=qn %>" name="questionNumber" type="text" required autofocus>  
                            </div>  
                            <div class="form-group">  
