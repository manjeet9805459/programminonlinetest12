            ...
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                 ...
                 <%
                    ...
                    int message =Integer.parseInt(request.getParameter("questionNumber"));
                    ++message;
                 %>
                <div class="panel-body">  
                    <form role="form"  action="/interAddQuestion1"  method="get" onsubmit="return validate()" name="form">  
                        <fieldset>
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" name="email" value="<%=s1 %> " type="hidden" required autofocus>   
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="Question number" name="questionNumber" type="int" value="<%=message %>">  
                            </div> 
                             <div class="form-group">  
                                <input class="form-control" placeholder="question " name="question" type="text" value="">  
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="True Answer" name="trueAnswer" type="text" value="">  
                            </div>
