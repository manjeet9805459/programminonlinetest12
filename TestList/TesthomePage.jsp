  ...
  <!-- Page Header NEW Test List -->
      ...
      <!-- Pagination -->
        ...
        <c:if test="${currentPage != 1}">
            <li class="page-item"><a class="page-link" href="/testHomePage?recordsPerPage=${recordsPerPage}&currentPage=${currentPage-1}">Previous</a>
            </li>
        </c:if>
            ...
            <c:choose>
             ...
             <c:otherwise>
                    <li class="page-item"><a class="page-link" 
                        href="/testHomePage?recordsPerPage=${recordsPerPage}&currentPage=${i}">${i}</a>
                    </li>
             </c:otherwise>
            </c:choose>
        </c:forEach>
        ...
        <c:if test="${currentPage lt noOfPages}">
            <li class="page-item"><a class="page-link" 
                href="/testHomePage?recordsPerPage=${recordsPerPage}&currentPage=${currentPage+1}">Next</a>
            </li>
        </c:if>              
           </ul>
           </nav>
