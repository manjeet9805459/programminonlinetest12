    ...
    <div class="container">
     ...
     <c:forEach items="${listBook}" var="question">
      <center>         
       <ul class="list-group">
      <il>
      <a class="btn btn-info btn-lg"  style="background-color: #008080" role="button"  href="/exm1?testSeriesNumber=<c:out value="${question.testSeriesNumber}"/>&testName=${testName}&questionNumber=${questionNumber}"><b>&nbsp Test Series &nbsp<c:out value="${question.testSeriesNumber}" /></b></a>
      </il>
      </ul>
      </center>
      </c:forEach>
