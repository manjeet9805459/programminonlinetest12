                    ...
                    <form action="/addQuestion"  method="get">  
                        <fieldset>  
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" name="testName" type="text" required autofocus>   
                            </div>
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" name="email" value="<%=s1 %>" type="hidden" required autofocus>   
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="Test Series Number" name="testSeriesNumber" type="text" value="<%=tsn %>" required autofocus>  
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="imag URL" name="imagesURL" type="text" required autofocus>  
                            </div> 
                               
                            <center><b><h2>Add The Question</h2></b></center>
                        
                            <div class="form-group">  
                                <input class="form-control" placeholder="question Number" name="questionNumber" type="text"  value="<%=qn %>" required autofocus>  
                            </div>  
                                <div class="form-group">  
