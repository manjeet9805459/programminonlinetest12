        ...
        <span class="icon-bar"></span>                        
           ...
           <button class="btn btn-default" type="submit">Go</button>
               ...
               <div class="row" style="background-color: #ADDFFF">
                   <h3>&nbsp&nbsp Question and answer list</h3>
                   <hr>
                   <c:forEach items="${listBook}" var="question">
              <div class="col-md-4 col-md-offset-4"> 
          <h2><c:out value="${question.question}"/></h2>
          <ul class="list-group">
    <li class="list-group-item"><c:out value="${question.questionOption1}"/></li>
    <li class="list-group-item"><c:out value="${question.questionOption2}"/></li>
    <li class="list-group-item"><c:out value="${question.questionOption3}"/></li>
    <li class="list-group-item"><c:out value="${question.questionOption4}"/></li>
  </ul>
</div>
</c:forEach>
               </div>
