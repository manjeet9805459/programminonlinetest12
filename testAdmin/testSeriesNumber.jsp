 ...
 <div class="container-fluid">
    ...
    <c:forEach items="${listBook}" var="question">
      <center>         
       <ul class="list-group">
       <il>
       <a class="btn btn-lg btn-primary" style="background-color: #008080" href="/readQuestion?email=<%=s1%>&testSeriesNumber=<c:out value="${question.testSeriesNumber}"/>&testName=<%= testName%>"><b>Test Series&nbsp <c:out value="${question.testSeriesNumber}" /></b></a>
      </il>
      </ul>
        </center>
      </c:forEach>
