 ...
 <!-- /SEO -->
  ...
  <!-- Bootstrap Core CSS -->
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
     ...
     <center>
      <a class="btn btn-info btn-lg" role="button" href="/EditTestName?email=<%=s1%>&testName=<%=  message %>"><b>&nbspEdit name test&nbsp </b></a>
     </center>
     ...
     <c:forEach items="${listBook}" var="question">
      ...
      <center>  
     <ul class="list-group">
         <a class="btn btn-info btn-lg" role="button" href="/EditQuestion?email=<%=s1%>&testName=<%=message%>&testSeriesNumber=<c:out value="${question.testSeriesNumber}"/>&questionNumber=<%=questionNumber%>"> <b>Edit test Series &nbsp</b><c:out value="${question.testSeriesNumber}"/></a>
    </ul>
    </center>
     </c:forEach>
  </div>
