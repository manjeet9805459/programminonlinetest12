        ...
        <div class="col-md-4 col-md-offset-4">  
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Add new test series</h3>  
                </div>  
                <div class="panel-body"> 
                    <c:forEach items="${listBook}" var="q1">
                    <form action="/addQuestion"  method="get">  
                        <fieldset>  
                             <div class="form-group">  
                               <input class="form-control" placeholder="Test Name"  value="${q1.testName}" name="testName" type="text" autofocus>   
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="Test Series Number" value="${q1.testSeriesNumber}" name="testSeriesNumber" type="text" required autofocus>  
                            </div>
                             <div class="form-group">  
                                <input class="form-control" placeholder="images URL" name="imagesURL" type="text" value="${q1.imagesURL}" required autofocus>  
                            </div>
                            <div class="form-group">  
                           ...
                           <center><b><h2>Add The Question</h2></b></center>
                        
                            <div class="form-group">  
                                <input class="form-control" placeholder="question Number" name="questionNumber" type="text" required autofocus>  
                            </div>  
                                <div class="form-group">  
                                <input class="form-control" placeholder="question" name="question" type="text" required autofocus>  
                            </div>
                                <div class="form-group">  
                                <input class="form-control" placeholder=" question Option 1" name="questionOption1" type="text" required autofocus>  
                            </div>
                                <div class="form-group">  
                                <input class="form-control" placeholder="Question option 2" name="questionOption2" type="text" required autofocus>  
                            </div>
                                <div class="form-group">  
                                <input class="form-control" placeholder="Question option 3" name="questionOption3" type="text" required autofocus>  
                            </div>
                                <div class="form-group">  
                                <input class="form-control" placeholder="Question option 4" name="questionOption4" type="text" required autofocus>  
                            </div>
                            <div class="form-group">  
                                <input class="form-control" placeholder="True Answer" name="trueAnswer" type="text" required autofocus>  
                            </div>
