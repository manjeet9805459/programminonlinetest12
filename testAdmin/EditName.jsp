        ...
        <div class="col-md-4 col-md-offset-4">  
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                  ...
                  <%
                      String message =request.getParameter("testName");
                   %>
                <div class="panel-body">  
                    <form action="/EdittestName1"  method="get">  
                        <fieldset> 
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" name="email" value="<%=s1 %>" type="hidden" required autofocus>   
                            </div>
                           <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" value="<%=message %>" name="testName" type="text" required autofocus />   
                            </div>
                            <div class="form-group">  
                               <input class="form-control" placeholder="Test Name" value="<%=message %>" name="testName1" type="hidden" required autofocus />   
                            </div>
